...
Scenes List – show all of your scenes (sorted by updatedAt) with create/edit/delete.
Scene Editor – form (name, description) + file upload(s) saved to Supabase Storage.
Scene Viewer – renders at least one uploaded model via a component you build by integrating Tech Soft 3D's assembly_creator code directly (no iframe), loading files from Supabase Storage URLs.
...
Deleting a scene should remove it from your Supabase data.
